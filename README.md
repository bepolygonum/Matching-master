...
```bash
java -jar matching-web/target/graphhopper-map-matching-web-0.11-SNAPSHOT.jar import map-data/xiamen.osm
```
...
```bash
java -jar matching-web/target/graphhopper-map-matching-web-0.11-SNAPSHOT.jar match matching-core/src/test/out/*.gpx
```
...
```bash
java -jar matching-web/target/graphhopper-map-matching-web-0.11-SNAPSHOT.jar getbounds matching-core/src/test/resources/test.gpx
```
